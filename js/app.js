define(['angularAMD', 'common/controllers/navbarcontroller',  'angular-ui-router','bootstrap', 'ui-bootstrap'], function (angularAMD, NavbarController, PublicController)
{
	...
	.run(['$rootScope','$state','$stateParams', function($rootScope, $state, $stateParams) {
		...
		$rootScope.$on('ON_LOGIN_SUCCESS', function(event, next) {
